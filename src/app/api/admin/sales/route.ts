...
export async function GET(request: Request): Promise<Response> {
  ...
  try {
    ...
    return refreshAdminSessionCookie(request, NextResponse.json({ data: await createGoogleAdminService().sales({ saleId: params.get("saleId"), startDate: params.get("startDate"), endDate: params.get("endDate") }) }));
  } catch (error) {
